...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,   KC_SPC,   KC_SPC,                       MO(1),    MO(2),    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [2] = LAYOUT(
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  MSRIGHT,  MSTOP,    _______,  _______,  MSISO,    MSBOT,    _______,  _______,  _______,  _______,            KC_MUTE,
    _______,  MSFIT,    _______,  _______,  MSFRONT,  _______,  _______,  _______,  _______,  MSLEFT,   _______,  _______,                      _______,  KC_VOLU,
    _______,  _______,  _______,  _______,  _______,  _______,  MSBACK,   _______,  _______,  _______,  _______,  _______,  _______,            KC_PGUP,  KC_VOLD,
